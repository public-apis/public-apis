...
- [Public APIs ![Build Status](https://travis-ci.org/public-apis/public-apis)](#public-apis-img-src%22httpstravis-ciorgpublic-apispublic-apis%22-alt%22build-status%22)
  - [Index](#index)
    - [Animals](#animals)
    - [Anime](#anime)
...
| [Graph Countries](https://github.com/lennertVanSever/graphcountries) | GraphQL API for country related data like currencies, languages, flags, regions+subregions and bordering countries | No | Yes | Unknown |
