...
| [Verimail](https://verimail.io) | Email address verification | `apiKey` | Yes | Yes |
| [Veriphone](https://veriphone.io) | Phone number validation and carrier lookup | `apiKey` | Yes | Yes |
