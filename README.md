...
| [AllNewsAPI](https://github.com/AllNewsAPI/mcp-server) | Live news search, top headlines and usage with AI sentiment and entity filtering | `apiKey` | `stdio`, `HTTP` | [Glama](https://glama.ai/mcp/servers/AllNewsAPI/mcp-server) |
