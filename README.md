...
| [InSight](https://api.nasa.gov/insight_weather/?api_key=DEMO_KEY&feedtype=json&ver=1.0) | Weather measurements from Mars provided by the InSight Mars lander located near Mars' equator | `apiKey` | Yes | Yes |
