...
| [Mascot Car Rental API](https://mascotcarrental.com/api/public/openapi.json) | Real-time car rental availability, pricing, and booking for Kos island, Greece. Designed for AI agent integration. | No | Yes | Yes |
