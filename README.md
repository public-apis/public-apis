...
| [Groq](https://console.groq.com/docs/api-reference) | A high-speed inference API for running open-source large language models on its LPU engine. | `apiKey` | Yes | No |
