...
| [RoadGoat Cities API](https://www.roadgoat.com/business/cities-api) | HQ Photo, geodata, known for tags, autocomplete, safety, budget, Covid, and more for 4+ million cities, towns, neighborhoods, regions, and countries | `apiKey` | Yes | No |
