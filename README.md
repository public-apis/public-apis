...
| [UnblockAPI](https://unblockapi.com) | Captcha solving (40+ types), browser rendering, temp email, SMS verification, screenshots & web search for AI agents | `apiKey` | Yes | Yes |
