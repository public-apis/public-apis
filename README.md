...
| [TWZRD Agent Intel](https://intel.twzrd.xyz) | Solana on-chain agent trust scoring via MCP, with tools to score and verify AI agent wallets | No | Yes | Yes |
...
| [btcnode.uk](https://btcnode.uk) | Bitcoin blockchain data, fees, mempool, SEC insider trades and Reddit sentiment | No | Yes | Unknown |
...
| [Mailtrap](https://mailtrap.io) | Email API and SMTP for transactional and bulk email, with a testing sandbox | `apiKey` | Yes | Unknown |
...
| [Astroworld](https://api.astroworldmc.com) | Free Minecraft data: mobs, biomes, items, enchantments, structures, commands and trades | No | Yes | Yes |
...
| [Artificial Intelligence Jobs](https://artificialintelligencejobs.co/developers) | Live AI/ML job listings from 260+ company career pages, with salary and location filters | No | Yes | Yes |
...
| [MediaCraft AI](https://mediacraft-x402-api.onrender.com) | Chinese content compliance review, EN↔CN translation and SEO optimization, billed per call | `apiKey` | Yes | Yes |
...
| [Statistics of the World](https://statisticsoftheworld.com/api-docs) | Economic data for 218 countries: GDP, population, inflation and 440+ IMF and World Bank indicators | No | Yes | Yes |
...
| [Warnely](https://warnely.com/developers) | Composite travel-safety scores for 180 countries, with an OpenAPI 3.1 spec, under CC BY 4.0 | No | Yes | Yes |
...
| [BuyWhere](https://buywhere.ai) | Real-time product catalog for AI agents across merchants in 7 Southeast Asian markets and the US | `apiKey` | Yes | Unknown |
