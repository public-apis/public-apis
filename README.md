...
| [TWZRD Agent Intel](https://intel.twzrd.xyz) | Solana on-chain agent trust scoring via MCP; score, resolve, and verify AI agent wallets | No | Yes | Yes |
...
| [btcnode.uk](https://btcnode.uk) | Bitcoin blockchain data, fees, mempool, SEC insider trades, Reddit sentiment, and micropayments | No | Yes | Unknown |
...
| [Astroworld](https://api.astroworldmc.com) | Free Minecraft data: mobs, biomes, items, enchantments, structures, commands, and achievements | No | Yes | Yes |
...
| [MediaCraft AI](https://mediacraft-x402-api.onrender.com) | Chinese content compliance review, translation, and SEO. Pay-per-call via x402 (Solana USDC) | `apiKey` | Yes | Yes |
...
| [Statistics of the World](https://statisticsoftheworld.com/api-docs) | Economic data for 218 countries: GDP, population, inflation, and indicators from IMF & World Bank | No | Yes | Yes |
...
| [Warnely](https://warnely.com/developers) | Travel-safety scores for 180 countries (FCDO, US State, GPI, WGI, and live incident wire) | No | Yes | Yes |
...
| [BuyWhere](https://buywhere.ai) | Product catalog API for AI agents across merchants in 7 countries (SG, MY, TH, VN, PH, ID, US) | `apiKey` | Yes | Unknown |
