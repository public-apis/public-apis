...
| [Open Government, France - Open APIs](https://api.gouv.fr/) | French Government Open APIs (Auth depends on the API) | `apiKey` / No | Yes | Unknown |
| [Open Government, France - Open Data](https://www.data.gouv.fr/) | French Government Open Data | `apiKey` | Yes | Unknown |
