...
| [DealerMax](https://github.com/VMAzure/dealermax-public-api) | Italian automotive marketplace API — used vehicles, long-term rental (NLT) offers, dealer directory, automotive knowledge base | `apiKey` | Yes | No |
