...
| [Rick and Morty](https://rickandmortyapi.com) | Access to characters, locations and episodes from the show | No | Yes | Yes |
| [Techy](https://techy-api.vercel.app/) | JSON and Plaintext API for tech-savvy sounding phrases | No | Yes | Unknown |
| [ThronesAPI](https://thronesapi.com/) | Game of Thrones characters API | No | Yes | Yes |
