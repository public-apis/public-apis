...
| [Jolpica F1](https://api.jolpi.ca/ergast/) | Open-source Formula 1 API with Ergast-compatible endpoints. | No | Yes | Unknown |
...
| [OpenF1](https://openf1.org) | Real-time and historical Formula 1 data API. | No | Yes | Yes |
