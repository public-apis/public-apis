...
| [Dogs](https://dog.ceo/dog-api/) | Based on the Stanford Dogs Dataset | No | Yes | Unknown |
...
| [RandomFox](https://randomfox.ca/floof/) | Random pictures of foxes | No | Yes | Yes |
| [RescueGroups](https://userguide.rescuegroups.org/display/APIDG/API+Developers+Guide+Home) | Adoption | No | Yes | Unknown |
| [Shibe.Online](http://shibe.online/) | Random pictures of Shibu Inu, cats or birds | No | No | Unknown |
...
| [GDAX](https://docs.gdax.com/#api) | Cryptocurrency Trading Platform | `apiKey` | Yes | Unknown |
...
| [LabStack](https://labstack.com/docs/api/currency) | Accurate and reliable live currency exchange rates for over 150 symbols | `apiKey` | Yes | Yes |

### Data Validation
API | Description | Auth | HTTPS | CORS |
|---|---|---|---|---|
| [LabStack](https://labstack.com/docs/api/email) | Check email address for syntax error, disposable mail server and valid SMTP mailbox | `apiKey` | Yes | Yes |
...
| [LabStack](https://labstack.com/docs/api/geocode) | Find IP to location, location to latitude-longitude and reverse | `apiKey` | Yes | Yes |
