...
| [Steam Spy](https://steamspy.com/api.php) | Game sales data and player statistics for Steam | No | Yes | Yes |
...
| [Twitch](https://dev.twitch.tv/docs/api/) | Game streams, videos, clips, broadcasters and game data | `OAuth` | Yes | Yes |
