...
def fake_user_agent() -> str:
    ...
    user_agents = ['Mozilla/5.0 (Windows NT 6.2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1467.0 Safari/537.36', 
...
def check_if_link_is_working(link: str) -> Tuple[bool, str]:
    ...
    error_message = ''
    try:
        resp = requests.get(link, timeout=25, headers={'User-Agent': fake_user_agent(), 
