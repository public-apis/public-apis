...
| [GB Postcodes](https://postcodes-api.co.uk/docs) | GB postcode autocomplete, GeoJSON boundaries, centroids, area metrics, radius and distance queries | `apiKey` | Yes | Yes |
