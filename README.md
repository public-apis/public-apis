...
| [MessengerX.io](https://messengerx.rtfd.io) | A FREE API for developers to build and monetize personalized ML based chat apps inside a website / app | `apiKey` | Yes | Yes |
