...
| [NameGender MCP](https://github.com/anpekesen/namegender-mcp) | Gender from names, emails and usernames, with probability and sample size | `apiKey` | `stdio` | [Glama](https://glama.ai/mcp/servers/anpekesen/namegender-mcp) |
