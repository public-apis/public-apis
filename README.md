...
| [NovaDax](https://doc.novadax.com/en-US/#introduction) | NovaDAX provides a series of API to access all market data, trading, order history and account management endpoints | `apiKey` | Yes | Unknown |
