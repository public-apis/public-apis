...
API | Description | Auth | HTTPS | CORS |
|:---|:---|:---|:---|:---|
| [ClinPGx](https://api.clinpgx.org/swagger) | Pharmacogenomics data including gene-drug interactions, CPIC guidelines, allele functions, and drug prescribing recommendations | No | Yes | Unknown |
