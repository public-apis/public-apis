...
| [Flight Data](https://travelpayouts-travelpayouts-flight-data-v1.p.rapidapi.com/v1/prices/direct/) | Get flight price trends and find popular destinations for your customers.| `OAuth` | Yes | Yes |
### Video
API | Description | Auth | HTTPS | CORS |
|---|---|---|---|---|
