...
API | Description | Auth | HTTPS | CORS |
|:---|:---|:---|:---|:---|
| [AeroDataBox](https://www.aerodatabox.com/api/s/flights) | Global air traffic and flight data | `apiKey` | Yes | Yes |
| [Astronomy Picture of the Day](https://github.com/nasa/apod-api) | NASA's Astronomy Picture of the Day (APOD) | `apiKey` | Yes | No |
| [Core](https://core.ac.uk/services#api) | Access the world's largest collection of open access research papers | `apiKey` | Yes | No |
| [EONET](https://eonet.sci.gsfc.nasa.gov/docs/v3) | International repository of data about natural hazards and events | No | Yes | No |
| [Exoplanet](https://exoplanetarchive.ipac.caltech.edu/docs/api.html) | Access to NASA's Exoplanet Archive database | No | Yes | Yes |
| [Forismatic](http://api.forismatic.com/api/1.0/) | Inspirational and random quotes | No | No | Unknown |
| [Image-Charts](https://documentation.image-charts.com/) | High performance, zero-dependency image chart generation | No | Yes | Yes |
| [InspiroBot](https://inspirobot.me/apigen) | Generate random inspirational quotes | No | Yes | No |
| [Launch Library 2](https://thespacedevs.com/llapi) | Spaceflight launches and events database | No | Yes | Yes |
| [MeteoMatics](https://www.meteomatics.com/en/api/) | Weather and climate data | `apiKey` | Yes | Yes |
| [NASA Image and Video Library | Searchable library of NASA's space photos and videos. | No | Yes | Unknown |
| [NASA Open APIs](https://api.nasa.gov/) | APIs from NASA, including near-earth objects, Earth imagery, and more | `apiKey` | Yes | No |
| [NCI CADD](https://wiki.nci.nih.gov/display/cadd/CADD+Chemical+Identifier+Resolver+%28CIR%29+API) | Chemical identifier resolution | No | Yes | No |
| [OpenSky](https://opensky-network.org/apidoc/rest.html) | Real-time flight tracking | No | Yes | No |
| [OpenWeatherMap](https://openweathermap.org/api) | Weather data API | `apiKey` | Yes | Unknown |
| [Periodic Table](https://api.periodictable.at/api/documentation) | Periodic table data | No | Yes | Yes |
| [PostGIS](http://postgis.net/docs/manual-2.5/postgis_overview.html) | Spatial and geographic objects for PostgreSQL | No | Yes | Unknown |
| [Science.gov](https://www.science.gov/developers.html) | API for Science.gov | No | Yes | Unknown |
| [SpaceX](https://github.com/r-spacex/SpaceX-API) | All SpaceX data including launches, rockets, missions and cores | No | Yes | No |
| [SpaceX REST](https://docs.spacexland.com/) | REST API for SpaceX launch, rocket, core, capsule, starlink, launchpad, and landing pad data | No | Yes | Yes |
| [USGS](https://www.usgs.gov/developer-api) | USGS data | No | Yes | Unknown |
| [ZenQuotes](https://zenquotes.io/) | Timeless quotes for the digital age | No | Yes | Yes |
