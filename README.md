...
| [Ollama](https://github.com/ollama/ollama/blob/main/docs/api.md) | Local large language model runner with REST API for text generation and embeddings | No | Yes | Yes |
