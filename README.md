...
| [Climatiq](https://climatiq.io/) | Automatically transform input factor data into CO2e values using emission factors from a range of validated sources | `apiKey` | Yes | Yes |
