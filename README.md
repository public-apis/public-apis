...
| [Reach Data](https://reachdata.ca/api.html) | Canadian province-level energy data — capacity, clean energy mix, electricity pricing, and AI suitability scores | `apiKey` | Yes | Yes || [Srp Energy](https://srpenergy-api-client-python.readthedocs.io/en/latest/api.html) | Hourly usage energy report for Srp customers | `apiKey` | Yes | No |
