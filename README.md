...
| [Blague.xyz](https://blague.xyz/) | La plus grande API de Blagues FR/The biggest FR jokes API | 'Authorization' | Yes | Yes |
...
| [CTS](https://api.cts-strasbourg.eu/) | CTS Realtime API | `CURLOPT_USERPWD` | Yes | Yes |
