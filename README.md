...
| [Hary Potter](https://github.com/bethfraser/hp-api) | The Harry Potter API returns spell routes, character routes, house, and sorting hat routes in JSON format | No | Yes | Unknown |
