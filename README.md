...
| [Infermedica](https://developer.infermedica.com/docs/) | NLP based symptom checker and patient triage API for health daignosis from text | `apiKey` | Yes | Yes |
...
| [BotsArchive](https://botsarchive.com/docs.html) | Get JSON formatted details about a Telegram Bot | No | Yes | Unknown |
