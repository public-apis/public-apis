...
| [DIA](https://docs.diadata.org) | Real-time crypto price data for 3000+ tokens from 80+ exchanges | No | Yes | Unknown |
...
| [DuckDuckGo](https://duckduckgo.com/api) | Zero-click info API returning instant answers for search queries | No | Yes | Yes |
