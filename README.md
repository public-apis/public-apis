...
| [NLP-API.com](https://www.nlp-api.com/documentation) | NLP tools for multi-lingual categorization, NER, topic tagging, sentiment analysis and more | `apiKey` | Yes | Yes |
