...
| [KLinePic](https://klinepic.com/guides/trade-review-chart-api/) | Generate annotated trade-review candlestick charts from broker and exchange fills | `apiKey` | Yes | No | |
