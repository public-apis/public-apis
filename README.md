<div align="center">
    <h1>Üvretsiz API</h1>
    <i>Yazılım ve web geliştirmede kullanım için ücretsiz API'lerin toplu listesi</i>
</div>
...
<div align="center">
    <sub>Proje</sub>
    <br />
    <a href="CONTRIBUTING.md">Katkıda Bulunan Rehber</a> •
    <a href="https://github.com/davemachado/public-api">Bu proje için API</a> •
    <a href="https://github.com/public-apis/public-apis/issues">Konular</a> •
    <a href="https://github.com/public-apis/public-apis/pulls">Çekme İstekleri</a> •
...
<div align="center">
    <sub>Proje için alternatif siteler (resmi olmayanlar)</sub>
    <br />
    <a href="https://free-apis.github.io">Bedava API</a> •
    <a href="https://devresourc.es/tools-and-utilities/public-apis">Geliştirme Kaynakları</a> •
    <a href="https://www.public-apis.ml">Genel API'ler Sitesi</a> •
    <a href="https://apihouse.vercel.app">Apihouse</a> •
    <a href="https://collective-api.vercel.app/">Toplu API'ler</a> 
</div>
...
<div align="center">
    <p>
        <a href="https://opencollective.com/public-apis">[ <strong>Sponsor olun </strong> ve Public API'leri ve onların bakımcılarını destekleyin ]</a>
    </p>
    <p><strong>Özellikle teşekkür:</strong></p>
    <p>
        <a href="https://apilayer.com#gh-light-mode-only">
            ...
            <div>
                <p><strong>API'leri herhangi bir ürüne entegre etmenin en hızlı yolu</strong></p>
            </div>
            <div>
                <sup>10 kat geliştirici deneyimi için tümü tek bir platformda basit programlanabilir yapı taşları olarak herkese açık API'leri keşfedin, keşfedin ve kullanın.</sup>
            </div>
        </a>
        <a href="https://apilayer.com#gh-dark-mode-only">
            ...
            <div>
                <sup>10x geliştirici deneyimi için tümü tek bir platformda basit programlanabilir yapı taşları olarak herkese açık API'leri keşfedin, keşfedin ve kullanın.</sup>
            </div>
        </a>
    </p>
</div>
...
* [Hayvanlar](#animals)
* [Anime](#anime)
* [Kötü Amaçlı Yazılımdan Koruma Virüs Programları](#anti-malware)
...
* [İşletme](#business)
* [Takvim](#calendar)
* [Bulut Depolama ve Dosya Paylaşımı](#cloud-storage--file-sharing)
* [Sürekli Entegrasyon](#continuous-integration)
* [Cryptocurrency - Kripto para](#cryptocurrency)
* [Döviz değişimi](#currency-exchange)
* [Veri doğrulama](#data-validation)
* [Gelişim](#development)
* [Sözlükler](#dictionaries)
* [Belgeler ve Verimlilik](#documents--productivity)
* [E-mail](#email)
* [Eğlence](#entertainment)
* [Çevre](#environment)
* [Olaylar](#events)
* [Finans](#finance)
* [Yemek ve İçecek](#food--drink)
* [Oyunlar ve Çizgi Romanlars](#games--comics)
...
* [Haberler](#news)
* [Açık veri](#open-data)
* [Açık Kaynak Projeleri](#open-source-projects)
* [Patent](#patent)
* [Kişilik](#personality)
* [Telefon](#phone)
* [Fotoğrafçılık](#photography)
* [Programlama](#programming)
* [Bilim ve Matematik](#science--math)
* [Security](#security)
* [Güvenlik](#shopping)
* [Sosyal](#social)
* [Spor ve Fitness](#sports--fitness)
* [Test Verisi - Test Data](#test-data)
* [Metin Analizi - Text Analysis](#text-analysis)
* [izleme](#tracking)
* [Toplu taşıma](#transportation)
* [URL Kısaltma](#url-shorteners)
* [Araç](#vehicle)
* [Video](#video)
* [Hava](#weather)

### Hayvanlar
API | Açıklama | Auth | HTTPS | CORS |
|---|---|---|---|---|
| [AdoptAPet](https://www.adoptapet.com/public/apis/pet_list.html) | Evcil hayvanların evlat edinilmesine yardımcı olacak kaynak | `apiKey` | Evet | Evet |
| [Axolotl](https://theaxolotlapi.netlify.app/) | Collection of axolotl pictures and facts | No | Evet | No |
| [Cat Facts](https://alexwohlbruck.github.io/cat-facts/) | Daily cat facts | No | Evet | No |
| [Cataas](https://cataas.com/) | Cat as a service (cats pictures and gifs) | No | Evet | No |
| [Cats](https://docs.thecatapi.com/) | Pictures of cats from Tumblr | `apiKey` | Evet | No |
| [Dog Facts](https://dukengn.github.io/Dog-facts-API/) | Random dog facts | No | Evet | Evet |
| [Dog Facts](https://kinduff.github.io/dog-api/) | Random facts of Dogs | No | Evet | Evet |
| [Dogs](https://dog.ceo/dog-api/) | Based on the Stanford Dogs Dataset | No | Evet | Evet |
| [eBird](https://documenter.getpostman.com/view/664302/S1ENwy59) | Retrieve recent or notable birding observations within a region | `apiKey` | Evet | No |
| [FishWatch](https://www.fishwatch.gov/developers) | Information and pictures about individual fish species | No | Evet | Evet |
| [HTTP Cat](https://http.cat/) | Cat for every HTTP Status | No | Evet | Evet |
| [HTTP Dog](https://http.dog/) | Dogs for every HTTP response status code | No | Evet | Evet |
| [IUCN](http://apiv3.iucnredlist.org/api/v3/docs) | IUCN Red List of Threatened Species | `apiKey` | No | No |
| [MeowFacts](https://github.com/wh-iterabb-it/meowfacts) | Get random cat facts | No | Evet | No |
| [Movebank](https://github.com/movebank/movebank-api-doc) | Movement and Migration data of animals | No | Evet | Evet |
| [Petfinder](https://www.petfinder.com/developers/) | Petfinder is dedicated to helping pets find homes, another resource to get pets adopted | `apiKey` | Evet | Evet |
| [PlaceBear](https://placebear.com/) | Placeholder bear pictures | No | Evet | Evet |
| [PlaceDog](https://place.dog) | Placeholder Dog pictures | No | Evet | Evet |
| [PlaceKitten](https://placekitten.com/) | Placeholder Kitten pictures | No | Evet | Yes |
