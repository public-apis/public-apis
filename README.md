...
| [NotebookLM]([https://nlpcloud.io](https://docs.cloud.google.com/gemini/enterprise/notebooklm-enterprise/docs/api-notebooks)) | AI-powered research tool to generate insights and summaries from documents | `OAuth` | Yes | Unknown |
