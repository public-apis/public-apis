...
| [Document Intelligence](https://learn.microsoft.com/en-us/azure/ai-services/document-intelligence/how-to-guides/use-sdk-rest-api) | Azure AI service that uses ml to extract key text and structure elements from documents | `apiKey` | Yes | Yes |
