...
- [Public APIs ![Build Status](https://travis-ci.org/toddmotto/public-apis)](#public-apis-build-statushttpstravis-ciorgtoddmottopublic-apis)
  - [Index](#index)
    - [Animals](#animals)
    - [Anime](#anime)
...
| [QuoteGarden](https://pprathameshmore.github.io/QuoteGarden/) | A REST API for quotes. The database currently includes more than 5000 motivational quotes. | No | Yes | Unknown
