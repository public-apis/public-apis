...
| [Azure DevOps api](https://docs.microsoft.com/en-us/rest/api/azure/devops/?view=azure-devops-rest-6.1) | The Azure DevOps basic components of a REST API request/response pair. | Yes | Yes | Unknown |
