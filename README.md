...
| [Space API Directory](https://github.com/SpaceApi/directory) | The SpaceAPI directory is a list of hackerspaces and makerspaces that have the SpaceAPI implemented | No | Yes | Yes |
