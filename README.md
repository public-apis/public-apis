...
| [SearchLink Lite](https://github.com/GlobalMatchHub/searchlink-lite) | Google Search Console clicks, impressions, queries and pages for sites you own | `OAuth` | `stdio` | [Glama](https://glama.ai/mcp/servers/GlobalMatchHub/searchlink-lite) |
