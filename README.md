...
API | Description | Auth | HTTPS | CORS |
|---|---|---|---|---|
| [CDC.gov](https://open.cdc.gov/apis.html) | Access the data from the CDC (Center of Disease Control) api  - cdc.gov | No | Yes | Unknown |
...
| [Decrypt.tools](https://decrypt.tools/api) | Encrypt text to hashes using decrypt.tools | No | Yes | Unknown |
