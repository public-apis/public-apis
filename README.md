...
| [Ipregistry](https://ipregistry.co/docs) | Fast, Reliable IP Geolocation and Threat Data API | `apiKey` | Yes | Yes |
...
| [Smartcar](https://smartcar.com/docs/) | Lock and unlock vehicles and get data | `OAuth` | Yes | Yes |
