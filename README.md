...
API | Description | Auth | HTTPS | CORS |
|:---|:---|:---|:---|:---|
| [Package Drift & Vulnerability Intelligence](https://api.pkgdrift.com) | Drift detection and CVE cross-reference for npm, PyPI, Cargo, RubyGems, and NVD | `apiKey` | Yes | Unknown |
