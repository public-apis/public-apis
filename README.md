...
| [Live Tennis](https://docs.livetennisapi.com) | Real-time tennis scores, players, fixtures and model win-probability for ATP, WTA, Challenger and ITF. Free tier available | `apiKey` | Yes | Yes |
